...
// создаем команды
Teams.Add("Red", "<size=44><color=Blue>Кинопленка</color></size>", { g: 1 });
Teams.Add("White", "<size=44><color=White>универсам</color></size>", { a: 1 });
Teams.Add("White", "<size=44><color=#Black>Разъезд</color></size>", { a: 1 });
Teams.Add("Black", "<size=44><color=White>Хади Такташ</color></size>", { g: 1 });
